...
function SignUp(e) {
  ...
  const handleSubmit = async(e, isLoggedIn) => {
    e.preventDefault();
  ...
  return (
    ...
    <div className="App">
        <div className="input">
          ...
          <h2></h2>
          <button type= 'submit' className="login" onClick={(e)=> handleSubmit(e, isLoggedIn)}>Sign Up</button>
          <h2></h2>
    ...
    <a href='/#Login'>
        <p1 class = "Signinbutton">LogIn</p1>
    </a>
