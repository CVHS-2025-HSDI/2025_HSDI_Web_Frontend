...
function CourseSchedule() {  
  ...
  return (
    ...
    <div>
      <a href="#home">
        <img className="falcon1" src="./logo.png" alt="Falcon"/>
      </a>
      <img className="person1" src="https://www.freeiconspng.com/uploads/clipart--person-icon--cliparts-15.png" alt="Person Icon" />
      <button className="Loggingin">Log In</button>
